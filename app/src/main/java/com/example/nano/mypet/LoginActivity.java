...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.btngo);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        public void clickemail_sign_in_button (View view)
        {
            TextView username = (TextView)findViewById(R.id.email);
            TextView password = (TextView)findViewById(R.id.password);

            String url = "http://172.20.10.2/login.php?user="+username+"&pass="+password;
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                if(response.getString("status") == "true"){
                                    ...
                                    Intent go=new Intent(LoginActivity.this, Main3Activity.class);
                                    go.putExtra("data_id", data_id);
                                    go.putExtra("data_firstname", data_firstname);
                                    go.putExtra("data_lastname", data_lastname);
                                    //startActivity(go);
                                    //Toast.makeText(LoginActivity.this,"Firstname: "+data_firstname+" Lastname:"+data_lastname , Toast.LENGTH_LONG).show();
                                }
                                else {
